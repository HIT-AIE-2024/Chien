...
class TextPreprocessor:
    ...
    def tokenize(self, method: str = 'whitespace') -> :
        """
        ...
        Returns:
            : A list of tokens obtained after tokenization.
        """
    ...
    def stemming(self, tokens: ) -> :
        ...
        Args:
            tokens (): A list of tokens to perform stemming on.
    ...
    def lemmatization(self, tokens: ) -> :
        ...
        Args:
            tokens (): A list of tokens to perform lemmatization on.
