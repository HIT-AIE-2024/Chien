...
stemmed_tokens = preprocessor.stemming(tokens_3)  # No need to pass tokens_1
print("Stemming:", stemmed_tokens)
print('-' * 60)
lemmatized_tokens = preprocessor.lemmatization(tokens_3)  # No need to pass tokens_1
